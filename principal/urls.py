...
urlpatterns = [
    ...
    path("registro/", views.registro, name="registrar"), # Página de Registro
    ...
    path("usuario/int/", views.usuario, name="usuario"), #Página para visualizar informações da conta, pode editar ou ir para "meus socorros"
    ...
    path("usuario/int/criar/int", views.criar), # Cria o o socorro e redireciona para "explorar/id_do_socorro" para visualiza-lo
